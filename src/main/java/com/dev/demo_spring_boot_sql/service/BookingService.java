...
import com.dev.demo_spring_boot_sql.repository.BookingRepository;
...
public class BookingService implements IBookingService {
    ...
    public BookedRoom findByBookingConfirmationCode(String confirmationCode) {
        ...
        -> new ResourceNotFoundException("No booking found with booking code with: " + confirmationCode));
    }
}
