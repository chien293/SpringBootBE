...
import com.dev.demo_spring_boot_sql.exception.PhotoRetrievalException;
...
import com.dev.demo_spring_boot_sql.service.BookingService;
...
public class RoomController {
    ...
    public ResponseEntity<List<RoomResponse>> getAllRooms() {
        List<Room> rooms = roomService.gettAllRooms();
    ...
    public ResponseEntity<List<RoomResponse>> getAvailableRooms(
        ...
        List<Room> availableRooms = roomService.getALlAvailableRooms(checkInDate, checkOutDate, roomType);
        List<RoomResponse> roomResponses = new ArrayList<>();
        ...
        }else return ResponseEntity.ok(roomResponses);
    }
